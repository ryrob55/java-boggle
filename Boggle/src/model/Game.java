...
public class Game
{
	...
	public Game()
	{
		...
		board = new Board();
		human = new HumanPlayer( dictionary );		// PA3
		computer = new ComputerPlayer( dictionary );	// PA3

	} // constructor

	/**
     * computerSetWords - sets the words for the computer.
     * 
     * @throws IOException
     */
    public void computerSetWords() throws IOException
    {
        // sets the words for the computer
        ((ComputerPlayer) computer).setWords(dictionary, board);
        
    } // method computerSetWords
